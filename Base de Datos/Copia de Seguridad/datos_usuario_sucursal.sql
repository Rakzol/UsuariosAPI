...
CREATE TABLE `sucursal` (
  ...
  CONSTRAINT `sucursal_chk_1` CHECK (regexp_like(`nombre`,_utf8mb4'^[a-zA-ZñÑáéíóúÁÉÍÓÚ]+( [a-zA-ZñÑáéíóúÁÉÍÓÚ]+)*$'))
...
INSERT INTO `sucursal` VALUES (2,'Guasave'),(3,'Higuera'),(1,'Mochis');
