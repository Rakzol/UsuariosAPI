...
CREATE TABLE `rol` (
  ...
  CONSTRAINT `rol_chk_1` CHECK (regexp_like(`nombre`,_utf8mb4'^[a-zA-ZñÑáéíóúÁÉÍÓÚ]+( [a-zA-ZñÑáéíóúÁÉÍÓÚ]+)*$'))
...
INSERT INTO `rol` VALUES (1,'Administrador'),(2,'Base De Datos'),(3,'Usuario');
